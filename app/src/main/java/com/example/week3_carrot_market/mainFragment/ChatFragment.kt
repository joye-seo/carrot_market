...
import com.example.week3_carrot_market.ChatAdapter
...
class ChatFragment : Fragment() {
    ...
    private val chat = listOf(
        ...
        Chat(R.drawable.ic_profile, "블루온", "앙평동", "4시간 전", "네 알겠습니다 :)"),
        Chat(R.drawable.ruffy, "방구봉", "신내1동", "1일 전", "물건판매되었나요?"),
        Chat(R.drawable.ruffy, "무무", "신내1동", "10일 전", "물건삽니다"),
        Chat(R.drawable.ic_profile, "토마베리쥬스", "방배1동", "1달 전", "넵!"),
        Chat(R.drawable.ic_profile, "노란당근", "망우동", "2달 전", "넵!!!!!!!!"),
        Chat(R.drawable.ruffy, "옹심", "망우본동", "2달 전", "네고부탁드립니다"),
        Chat(R.drawable.ruffy, "상봉동주민", "논현동", "1년 전", "😻"),
        Chat(R.drawable.ic_profile, "이카루스", "인창동", "2년 전", "하이"),
    )
